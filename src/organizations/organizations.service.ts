...
import { CreateOrganizationDto } from './dto/create-organization.dto';
import { UpdateOrganizationDto } from './dto/update-organization.dto';
import { saveImage } from 'utils/image.utils'; // Assuming you have this utility function
...
export class OrganizationService {
  ...
  async create(createOrganizationDto: CreateOrganizationDto): Promise<{ message: string }> {
    ...
    // // Example for validating image or other fields
    // let imageUrl: string | undefined;
    // if (createOrganizationDto.image) {
    //   imageUrl = saveImage(createOrganizationDto.image);
    // }
  ...
  //   // Convert the string ID to number if the ID in your entity is a number
